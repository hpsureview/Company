...
import com.example.firma.Service.DepatmentServuce;
...
public class DepartmentController {
    ...
    public ResponseEntity<?> insert(@Valid @RequestBody IshchiCompany dto){
        ...
        else if(insert1.equals("Bunady ishchi mavjud"))
    ...
    public ResponseEntity<?> select(@PathVariable Integer id){
        if(service.select(id)==null)
            return ResponseEntity.badRequest().body("Buday firma yo'q");
    ...
    public ResponseEntity<?> upadte(@PathVariable Integer id, @Valid @RequestBody IshchiCompany dto){
        ...
        else if(s.equals("Bunady ishchi mavjud"))
    ...
    public ResponseEntity<?> delete(@PathVariable Integer id){
        ...
        return ResponseEntity.badRequest().body("Bunday ishchi yo'q");
    }
